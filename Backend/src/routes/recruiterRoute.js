...
const { registerRecruiter, loginRecruiter, updatePassword, getRecruiterDetails, removeSavedCandidate, getRecruiterDetailsById, updateProfile, updateProfileImage, jobPost, saveCandidateProfile, getSavedCandidate, getFollowers, removeFollower, getStatistics, getAllRecruiterDetails } = require('../controllers/recruiterController');
